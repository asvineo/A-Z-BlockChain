...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Vinodh', amount = 1)
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message' : 'The nodes had different chain, so the chain has been replaced with the long chain',
